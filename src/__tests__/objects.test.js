...
describe('createTalkingPerson', () => {
  xit('returns a person who can introduce themselves', () => {
    ...
    expect(bill.introduce('Penny')).toEqual('Hi Penny, my name is Bill and I am 40!');

    expect(catherine.introduce('Zoe')).toEqual('Hi Zoe, my name is Catherine and I am 21!');
    expect(catherine.introduce('Bob')).toEqual('Hi Bob, my name is Catherine and I am 21!');
  });
});

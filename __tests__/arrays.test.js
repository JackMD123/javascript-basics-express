...
describe('/arrays', () => {
  describe('POST /element-at-index/{index}', () => {
    it.only('returns the element at the given index', done => {
      request(app)
  ...
  describe('POST /to-string', () => {
    it.only('returns the stringified array', done => {
      request(app)
  ...
  describe('POST /append', () => {
    it.only('returns an array with the value appended', done => {
      request(app)
        .post('/arrays/append')
        .send({
  ...
  describe('POST /starts-with-vowel', () => {
    it.only('returns a filtered array of elements starting with a vowel', done => {
      request(app)
  ...
  describe('POST /remove-element?index={index}', () => {
    it.only('returns an array with the first element removed', done => {
      request(app)
